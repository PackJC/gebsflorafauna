class PrepareTurkey extends PrepareFish
{
	int ran;	
	override void Init()
	{
		...
		//INGREDIENTS
		//ingredient 1
		InsertIngredient(0,"geb_Turkey");//you can insert multiple ingredients this way
		...
		for (int i = 0; i < ran; ++i){
			AddResult("geb_TurkeyMeat");//add results here
